...
function [matrix_magnVector] = preprocess_data_1_mouse_1_marker_3(id_mouse, id_marker)
...
matrix_magnVector = zeros(length(first_idx),301+t_max);
    ...
    for i = 1:length(first_idx)
        ...
        matrix_magnVector(i,:) = plot_labeled_markers_over_time_3(UnrolledCell,id_marker,samples_of_interest);
